                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-9ce8abf4732c6a0bc8d72a2930b1ef43"' :
                                            ...
                                            <li class="link">
                                                <a href="components/ViewmyselfComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ViewmyselfComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                                <li class="chapter inner">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/Gathering.html" data-type="entity-link">Gathering</a>
                            </li>
                            <li class="link">
